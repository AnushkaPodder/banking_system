...
<body style = "background: url(img/plain.jpg);">
	...
	<ul >
			...
			<div id="main">
			    ...
			    <p> Softora Bank provides you an opportunity for secured money transfer online. It transfers money between different users. If the user's account has required balance, money is transferred sucessfully.
			    	<br>
